...
def build_analysis_prompt(
    ...
    if qualification_params:
        qual_instruction = (
            ...
            '   b) LISTE DI VETTORI / FORNITORI ("uno dei seguenti" / "tra cui"):\n'
            '      Se il parametro è una lista di vettori/corrieri accettati, basta che il prospect usi\n'
            '      ALMENO UNO dei vettori nella lista. Se il prospect usa più vettori, alcuni non in lista,\n'
            '      il parametro è comunque SODDISFATTO grazie a quello in lista.\n'
            ...
            '   e) DICHIARAZIONI FUTURE ("lo faremo", "prevediamo di arrivare a X", "stiamo crescendo"):\n'
            '      Se il prospect dichiara valori che RAGGIUNGERÀ in futuro (ma ATTUALMENTE non ha):\n'
            '      → Il parametro è tecnicamente NON soddisfatto oggi, ma con prospettiva positiva.\n'
            '      → NON impostare "fuori_parametro": true.\n'
            '      → In "parametri_verificati" aggiungi il parametro con prefisso "⚠️ Dichiarazione futura:".\n'
            '        Es. "⚠️ Dichiarazione futura — Spesa spedizioni: prospect prevede di raggiungere\n'
            '             15.000€/anno nel prossimo anno (valore attuale non dichiarato)".\n'
            '      → Nella "spiegazione" della qualificazione aggiungi il flag:\n'
            '        "⚠️ Qualifica parzialmente basata su dichiarazioni future — valori non ancora verificabili."\n'
            '      → RATING MASSIMO per dichiarazioni future: 3 (sufficiente), anche se tutti i parametri\n'
            '        sono soddisfatti su base prospettica. Il rating sale a 4-5 solo se esistono ANCHE\n'
            '        valori storici/attuali confermati che rispettano la soglia.\n'
            '      ⚠️ DISTINZIONE importante:\n'
            '        - Valore storico passato (es. "l\'anno scorso abbiamo speso X") → più affidabile,\n'
            '          rating normale, nessun flag.\n'
            '        - Valore futuro/prospettico (es. "prevediamo di spendere X") → meno affidabile,\n'
            '          rating cappato a 3, flag obbligatorio nella spiegazione.\n\n'
            '   f) CALCOLO RATING:\n'
            '      - 100% parametri verificati e conformi (valori attuali/storici) → rating 5\n'
            '      - 75-99% → rating 4\n'
            '      - 50-74% → rating 3\n'
            '      - 25-49% → rating 2\n'
            '      - < 25% parametri verificati → rating 2 (qualità chiamata bassa, ma NON fuori target)\n'
            '      - "fuori_parametro": true → rating 1\n\n'
            '   g) APPUNTAMENTO NON IN TARGET ("fuori_parametro": true) SOLO SE:\n'
            '      - Il prospect ha CONFERMATO valori che non rispettano i criteri richiesti\n'
            '        (es. budget dichiarato troppo basso, vettore usato non in lista e ne usa SOLO di non in lista).\n'
            '      ❌ NON è fuori target se i parametri non sono stati raccolti completamente.\n'
            '      ❌ NON è fuori target se il prospect usa anche vettori non in lista ma almeno uno è accettato.\n'
            '      ❌ NON è fuori target se il prospect all\'inizio dice "non so" ma poi conferma un valore valido.\n'
            '      Nella "spiegazione" indica: il parametro fuori soglia, il valore dichiarato vs la soglia.'
        )
    else:
        qual_instruction = (
