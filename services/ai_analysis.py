...
def build_analysis_prompt(
    ...
    if qualification_params:
        qual_instruction = (
            ...
            '      Se un parametro ammette più alternative (es. "deve avere X OPPURE Y"), il parametro è\n'
            '      SODDISFATTO se ALMENO UNA delle alternative è verificata nella chiamata.\n'
            '      NON inserirlo in "parametri_mancanti" e NON impostare "fuori_parametro": true per quel motivo.\n'
            '      Esempio: "corriere abituale OPPURE spedisce almeno 3 pacchi/settimana" → se l\'operatore\n'
            '      ha verificato una sola delle due condizioni e il prospect soddisfa quella, il parametro è OK.\n\n'
